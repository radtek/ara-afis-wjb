...
public class Person implements Serializable {
	...
	public static Person convert(Person person) throws Exception {
	...
	public static void parseObjectForWeb(Person person){
		switch (person.sex){
			case "1":
				person.setSex("Male");
				break;
			case "2":
				...
				break;
			default:
				person.setSex("Unknown");
				break;
		}
		switch (person.activeStatus){
			case "E":
				person.setActiveStatus("Enabled");
				break;
			default:
				person.setActiveStatus("Disabled");
				break;
		}
	}
